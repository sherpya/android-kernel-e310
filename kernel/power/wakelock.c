...
struct wake_lock idle_wake_lock_for_suepend;  // for Tcxo shutdown
...
static int __init wakelocks_init(void)
{
	...
	wake_lock_init(&idle_wake_lock_for_suepend, WAKE_LOCK_IDLE, "suspending"); // for Tcxo shutdown
...
err_platform_device_register:
	...
	wake_lock_destroy(&idle_wake_lock_for_suepend);  // for Tcxo shutdown
#ifdef CONFIG_WAKELOCK_STAT
