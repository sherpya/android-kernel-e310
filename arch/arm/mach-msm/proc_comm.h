...
enum {
	...
	// CCI Modem_L1 Add Begin
/*SMEM Communication*/
	PCOM_CHG_GET_CHARGER_STATUS,
	PCOM_GET_IMEI,
	PCOM_CCI_SET_CHARGING_ONLY,
	PCOM_CCI_AUDIOTEST,
	PCOM_CCI_READ_ADC,
	PCOM_CCI_BACKUP_READ,
	PCOM_CCI_SDTEST,
	PCOM_CCI_GPIO_CONFIG_REMOTE,
	PCOM_CCI_READ_ADC_USB_ID,
	PCOM_CCI_CAMERA,
	PCOM_CCI_NOTIFY_BATTERY_TEMPERATURE,
	PCOM_CCI_SET_AC_OR_USB,
	PCOM_CCI_SET_CODEC_TX_GAIN,
	PCOM_CCI_READ_ADIE_REGISTER,
	PCOM_CCI_WRITE_ADIE_REGISTER,
	PCOM_CCI_ENABLE_TSSC,
	PCOM_CCI_DISABLE_TSSC,
	PCOM_CCI_SET_AUX_PGA_GAIN, //HarveyChang, 2009/06/09, Modem_7K_532, [Modem_L1][LQ86]FM audio path changed and output gain adjustment 
        PCOM_CCI_VIBRATE,
// CCI Modem_L1 Add End
};
