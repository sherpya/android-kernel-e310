...
static struct android_usb_product usb_products[] = {
	{
		.product_id	= C4_PID_ADB_DISABLE,//0x9026,
		.num_functions	= ARRAY_SIZE(usb_functions_default),
		.functions	= usb_functions_default,
	},
	{
		.product_id	= C4_PID_ADB_ENABLE,//0x9025,
		.num_functions	= ARRAY_SIZE(usb_functions_default_adb),
		.functions	= usb_functions_default_adb,
	},
	{
		.product_id	= C4_PID_RNDIS_MODE,//0xf00e,
		.num_functions	= ARRAY_SIZE(usb_functions_rndis),
		.functions	= usb_functions_rndis,
	},
	{
		.product_id	= C4_PID_RNDIS_MODE,//0x9024,
...
static struct i2c_board_info i2c_devices[] = {
	...
	{
	        I2C_BOARD_INFO("accelerometer", 0x53),
	},
#endif
};

#ifdef CONFIG_MSM_CAMERA
static uint32_t camera_off_gpio_ov5642_table[] = {
	/* parallel CAMERA interfaces */
	GPIO_CFG(0,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* PWDN */
...
static uint32_t camera_on_gpio_ov5642_table[] = {
	/* parallel CAMERA interfaces */
	GPIO_CFG(0,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA), /* PWDN */
	GPIO_CFG(1,  0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_UP, GPIO_CFG_2MA), /* RESET */
...
static int config_camera_on_gpios(void)
{
	...
	config_gpio_table(camera_on_gpio_ov5642_table,
		ARRAY_SIZE(camera_on_gpio_ov5642_table));
	return 0;
}
...
static void config_camera_off_gpios(void)
{
	...
	config_gpio_table(camera_off_gpio_ov5642_table,
		ARRAY_SIZE(camera_off_gpio_ov5642_table));
}
...
static unsigned int msm_sdcc_status(struct device *dev)
{
	unsigned int status;
			...
			status = (unsigned int) gpio_get_value(19); //modified for DVT
    ...
    char *page, char **start, off_t off, int count, int *eof, void *data)
{
	...
	{
		strcpy(modem_version, "C4-");
	}
	else
	{
		strcpy(modem_version, "K5-");
	}
	strcat(modem_version, modem_version_temp); 
